              ...
              child: Column(
                ...
                children: [
                  ...
                  LayoutBuilder(builder: (context, constraints) {
                    ...
                    final buttonWidth = (rowWidth - (3 * 10.w)) / 4;
                    ...
                    return Center(
                      child: SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            _buildActionButton(SvgManager.importWhite, finalWidth),
                            _buildActionButton(SvgManager.editPencilWhite, finalWidth),
                            _buildActionButton(SvgManager.micWhite, finalWidth),
                            _buildActionButton(SvgManager.cameraWhite, finalWidth),
                          ],
                        ),
                      ),
                    );
