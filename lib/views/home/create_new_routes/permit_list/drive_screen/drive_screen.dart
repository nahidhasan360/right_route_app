    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          // MAP
          // ═══════════════════════════════════════════════════════════
          // 🔴 MaplibreMap-কে Listener দিয়ে Wrap করা হলো টাচ ডিটেক্ট করার জন্য
          Listener(
            onPointerDown: (_) {
              // ইউজার ম্যাপে টাচ করলে ট্র্যাকিং অফ হয়ে যাবে
            ...
            child: MapLibreMap(
              ...
              // ❌ onCameraMoveStarted রিমুভ করা হয়েছে কারণ Listener টাচ ডিটেক্ট করছে
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: [
                ...
                _btn(
                    'Offline Map', () {}), // Empty button as seen in screenshot
